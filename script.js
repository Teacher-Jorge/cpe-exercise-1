//CPE exercises - Page 01 - Question 1
...
input1.addEventListener('keyup', (e) => {
    if (e.key === 'Enter' && input1.value === 'ableist') {
        word1.textContent = 'ableist'
...
//CPE exercises - Page 01 - Question 2
...
input2.addEventListener('keyup', (e) => {
    if (e.key === 'Enter' && input2.value === 'abominable') {
        word2.textContent = 'abominable'
...
//CPE exercises - Page 01 - Question 3
...
input3.addEventListener('keyup', (e) => {
    if (e.key === 'Enter' && input3.value === 'abrasiveness') {
        word3.textContent = 'abrasiveness'
...
//CPE exercises - Page 01 - Question 4
...
input4.addEventListener('keyup', (e) => {
    if (e.key === 'Enter' && input4.value === 'abridging') {
        word4.textContent = 'abridging'
...
//CPE exercises - Page 01 - Question 5
...
input5.addEventListener('keyup', (e) => {
    if (e.key === 'Enter' && input5.value === 'abrogation') {
        word5.textContent = 'abrogation'
